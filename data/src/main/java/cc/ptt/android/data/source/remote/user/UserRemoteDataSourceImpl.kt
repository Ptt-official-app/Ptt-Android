...
import cc.ptt.android.data.model.remote.user.existuser.ExistUserRequest
...
import cc.ptt.android.data.model.remote.user.userid.UserIdEntity
...
class UserRemoteDataSourceImpl constructor(
    ...
    override fun userId(): Flow<UserIdEntity> = userApi.userId()
}
