...
public class FavoriteBoardsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener,View.OnLongClickListener , ItemMoveCallback.ItemTouchHelperContract{
    ...
    public FavoriteBoardsListAdapter(Context context, List<Map<String, Object>> items, StartDragListener startDragListener) {
        this.data = items;
