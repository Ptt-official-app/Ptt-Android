...
public class HotArticleListAdapter extends StickyAdapter<RecyclerView.ViewHolder, RecyclerView.ViewHolder> implements View.OnClickListener,View.OnLongClickListener{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderO, final int position) {
        ...
        if(holderO instanceof ViewHolder){
            ...
            long timeL=Long.parseLong(StringUtils.notNullString(data.get(position).get("date")))/1000;
            ...
            holder.mTextView_class.setText(StringUtils.notNullString(data.get(position).get("board")+" / "+StringUtils.notNullString(data.get(position).get("class"))));


            holder.mTextView_auth.setText(StringUtils.notNullString(data.get(position).get("auth")));


            StringUtils.SortDecimal commit_ = StringUtils.sortDecimal(StringUtils.notNullString(data.get(position).get("commit")));
