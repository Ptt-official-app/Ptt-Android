...
public class ArticleReadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener,View.OnLongClickListener{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case 4:
                ...
                return holder6;
            case 5:
                View view6 = inflater.inflate(R.layout.article_read_item_commit_sort, parent, false);
                //view1.setOnClickListener(this);
                //view1.setOnLongClickListener(this);
    ...
    public int getItemViewType(int position) {
        ...
        if(StringUtils.notNullString(data.get(position).get("type")).equalsIgnoreCase("header")){
            pos=0;
        }else if(StringUtils.notNullString(data.get(position).get("type")).equalsIgnoreCase("content")){
            pos=1;
        }else if(StringUtils.notNullString(data.get(position).get("type")).equalsIgnoreCase("content_image")){
            pos=2;
        }else if(StringUtils.notNullString(data.get(position).get("type")).equalsIgnoreCase("center_bar")){
            pos=3;
        }else if(StringUtils.notNullString(data.get(position).get("type")).equalsIgnoreCase("commit")){
            pos=4;
        }else if(StringUtils.notNullString(data.get(position).get("type")).equalsIgnoreCase("commit_sort")){
            pos=5;
        }else if(StringUtils.notNullString(data.get(position).get("type")).equalsIgnoreCase("commit_bar")){
            pos=6;
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holderO, final int position) {
        ...
        if(holderO instanceof ViewHolderHeader){
            ...
            holder.mTextView_board.setText(StringUtils.notNullString(data.get(position).get("board"))+" / "+StringUtils.notNullString(data.get(position).get("class")));
            ...
            //Log.d(this.getClass().getName(),"mText.getLineHeight() = "+holder.mTextView_text.getLineHeight());
            ...
            Future<PrecomputedTextCompat> future = PrecomputedTextCompat.getTextFuture(
                    StringUtils.ColorString(StringUtils.notNullString(data.get(position).get("text"))),  holder.mTextView_text.getTextMetricsParamsCompat(), null);
            ...
            Future<PrecomputedTextCompat> future = PrecomputedTextCompat.getTextFuture(
                    StringUtils.ColorString(StringUtils.notNullString(data.get(position).get("text"))),  holder.textView_text.getTextMetricsParamsCompat(), null);
            ...
            StringUtils.SortDecimal floor_ = StringUtils.sortDecimal(StringUtils.notNullString(data.get(position).get("floor")));
            ...
            StringUtils.SortDecimal like_ = StringUtils.sortDecimal(StringUtils.notNullString(data.get(position).get("like")));
            //holder.textView_floor.setText((StringUtils.notNullString(data.get(position).get("floor"))));
            ...
            int like = 0;
            try{
                like = Integer.parseInt((StringUtils.notNullString(data.get(position).get("like"))));
            }catch (Exception e){
        ...
        try{
            ControllerListener controllerListener = new BaseControllerListener<ImageInfo>() {
                ...
                public void onFinalImageSet(
                    ...
                    double caculor = (StaticValue.widthPixels / imageInfo.getWidth() * imageInfo.getHeight());
            ...
            hierarchy = builder
                    .setPressedStateOverlay(context.getResources().getDrawable(R.drawable.image_click))
