package tw.y_studio.ptt.utils.fresco;
...
public class MyOkHttpNetworkFetcher
        extends BaseNetworkFetcher<MyOkHttpNetworkFetcher.MyOkHttpNetworkFetchState> {
                ...
                new okhttp3.Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        try {
                            ...
                            // if(contentLength>1024*1024*12) throw new
                            // Exception("檔案超過12MB限制("+(contentLength/1024/1024)+"MB)"+"\n請自行開啟連結");
