...
public abstract class StickyAdapter<
                SVH extends RecyclerView.ViewHolder, VH extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<VH> {

    /**
     * This method gets called by {@link StickyHeaderItemDecorator} to fetch the position of the
    ...
    /**
     * Called only twice when {@link StickyHeaderItemDecorator} needs a new {@link
     * RecyclerView.ViewHolder} to represent a sticky header item. Those two instances will be
     * cached and used to represent a current top sticky header and the moving one.
     *
     * <p>You can either create a new View manually or inflate it from an XML layout file.
     *
     * <p>The new ViewHolder will be used to display items of the adapter using {@link
     * #onBindHeaderViewHolder(RecyclerView.ViewHolder, int)}. Since it will be re-used to display
