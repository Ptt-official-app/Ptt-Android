...
public class UiFix {
     ...
     */
    public static void changeMenuItemCheckedStateColor(
            BottomNavigationView bottomNavigationView, int checkedColorHex, int uncheckedColorHex) {
        int[][] states =
                new int[][] {
        ...
        int[] colors = new int[] {uncheckedColorHex, checkedColorHex};
    ...
    public static void setSwipeRefreshLayoutBackground(
            SwipeRefreshLayout mSwipeRefreshLayout, Activity _mActivity) {
