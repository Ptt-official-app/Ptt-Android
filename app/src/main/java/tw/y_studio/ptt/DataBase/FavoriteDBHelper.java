...
public class FavoriteDBHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_CREATE_TABLE_1 =
            "CREATE TABLE IF NOT EXISTS "
                    ...
                    + "_other3 TEXT"
                    + ");";
    public static final String[] colum = {
        "_ID", "_Board", "_Ttle", "_Category", "_Index",
    };

    public FavoriteDBHelper(
    ...
    public List<Map<String, Object>> getAll() throws Exception {
        ...
        db.beginTransaction();
        Cursor cursor =
                db.query(this._TableName, colum, null, null, null, null, "_Index ASC", null);
        if (cursor != null) {
    ...
    public void insertBoard(String board, String title, String Category, int index)
            throws Exception {
        SQLiteDatabase db = getWritableDatabase();
    ...
    public static ContentValues newContentValues(
            String board, String title, String Category, int index) {
        ContentValues values = new ContentValues();
        values.put("_Board", board);
        values.put("_Ttle", title);
        values.put("_Category", Category);
    ...
    public int getMaxIndex() {
        ...
        db.beginTransaction();
        Cursor cursor =
                db.query(this._TableName, colum, null, null, null, null, "_Index DESC", "1");
        if (cursor != null) {
            cursor.moveToFirst(); // 將指標移到第一筆資料
            for (int i = 0; i < cursor.getCount(); i++) {
