...
public class SearchBoardsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public int getItemViewType(int position) {
        int pos =
                context.getSharedPreferences("MainSetting", MODE_PRIVATE).getInt("SEARCHSTYLE", 0);
        return pos;
    }
