...
import cc.ptt.android.databinding.ArticleReadItemCenterBarBinding
import cc.ptt.android.databinding.ArticleReadItemCommitBarBinding
import cc.ptt.android.databinding.ArticleReadItemCommitBinding
import cc.ptt.android.databinding.ArticleReadItemContentBinding
import cc.ptt.android.databinding.ArticleReadItemHeaderBinding
import cc.ptt.android.databinding.ArticleReadItemImageBinding
import cc.ptt.android.domain.model.ui.article.ArticleReadInfo
import coil.load
import java.lang.Exception
import java.lang.RuntimeException

class ArticleReadAdapter(
    private val data: List<ArticleReadInfo>,
    ...
    inner class ViewHolderContentImage(
        view: View,
    ) : RecyclerView.ViewHolder(view) {
    ...
    inner class ViewHolderCenterBar(
        view: View,
    ) : RecyclerView.ViewHolder(view) {
    ...
    inner class ViewHolderCommitBar(
        view: View,
    ) : RecyclerView.ViewHolder(view) {
